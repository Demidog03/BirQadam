...
const AuthPage: FC = () => {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen h-full py-[50px] justify-center items-center gap-10">
      <h1 className="text-sky-700 text-4xl font-bold">OneStep</h1>
      <Tabs className="w-[400px]" value={value} onValueChange={onTabChange}>
