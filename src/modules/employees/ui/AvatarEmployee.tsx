...
const AvatarEmployee: FC<AvatarInterface> = ({ isActive = false, imageSrc, firstName, lastName, email = false }) => {
  return (
    <div className="w-[56px] h-[56px] relative">
      ...
      <AvatarIcon className='w-full h-full'>
        ...
        <AvatarFallback className='bg-[#579cd8] text-[#ffffff] text-xl'>{email ? <BiMailSend/> : firstName[0] + lastName[0]}</AvatarFallback>
      </AvatarIcon>
    </div>
